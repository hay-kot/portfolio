      ...
      >
        <div>
          <nuxt-link v-if="theme === 'theme-light'" to="/">
            <div
              class="text-3xl font-bold w-full text-center sm:text-left text-green-700 leading-tight"
            >
              hay-kot.dev
            </div>
          </nuxt-link>
          <nuxt-link v-else to="/">
            <div
              class="text-3xl font-bold w-full text-center text-white sm:text-left leading-tight"
            >
              hay-kot.dev
            </div>
          </nuxt-link>
        ...
        >
          ...
          <li>
            <nuxt-link to="/blog" class="text-copy-primary hover:text-gray-600">
              Blog
            </nuxt-link>
