  ...
  <div>
    <div>
      ...
      >
        ...
        >
          <div class="leading-tight">hay-kot.dev</div>
          <div class="text-green-700 leading-tight">Freelance Developer</div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row items-center my-8">
          ...
          <div class="flex-1 text-lg sm:text-xl ml-6">
            <p class="text-lg sm:text-xl">
              ...
              applications my wife and I to use. To learn more about what I'm
              hosting, check out my
      ...
      <TheProjectSummary v-if="false" />

      <section>
        <h2 class="font-bold text-center text-4xl" id="projects">
          Project Highlights
        </h2>
        <ProjectCard class="border-b border-t py-6" />
      </section>

      <section class="overflow-x-hidden border-gray-200 border-b">
        <div
        ...
        >
          ...
          >
            ...
            <div class="flex-1 text-lg sm:text-xl ml-6">
              Hayden is a Building Automation Engineer at Johnson Controls.
              While not a programmer by trade, Hayden spends his free time
              contributing to open source projects and building utility
              applications to support the community.
            </div>
          </div>
        </div>
        <!-- end get-to-know me -->
...
export default {
  components: { TheProjectSummary, AppButton, ProjectCard },
  data() {
    return {
